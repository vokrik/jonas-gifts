...
export type ProductCardProps = Product & { onReserve: (name: string) => void }
...
export default function ProductCard({ image, title, price, link, isReserved, onReserve }: ProductCardProps) {
  return (
